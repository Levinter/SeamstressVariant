...
namespace SeamstressVariant.Survivors.SeamstressVariant.SkillStates
{
    public class SlashCombo : BaseMeleeAttack
    {
        public override void OnEnter()
        {
            ...
            swingEffectPrefab = SeamstressVariantAssets.swordSwingEffect;
            hitEffectPrefab = SeamstressVariantAssets.swordHitImpactEffect;

            impactSound = SeamstressVariantAssets.swordHitSoundEvent.index;
