...
namespace SeamstressVariant.Survivors.SeamstressVariant
{
    public static class SeamstressVariantStaticValues
    {
        ...
        public const float scissorDamageCoefficient = 4.0f;
        public const float dashDamageCoefficient = 2.5f;

        // Explosion deals this much flat damage per 100 heart consumed.
        public const float explodeDamagePerHundredHeart = 20f;
